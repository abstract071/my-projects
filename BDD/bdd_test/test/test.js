...
define(function (require) {
    ...
    describe('Creating an employee with right type parameter', function () {
        ...
        it('should be equal to instance of the regular FixedSalaryEmployee instance', function () {
            var fixedSalaryFactoryEmployee = new EmployeeFactory().createEmployee({ type: "FixedSalaryEmployee",
                                                                                    salary: 50,
                                                                                    name: "John Doe",
                                                                                    id: 999 });
        ...
        it('should throw an exception because of class types incompatibility ', function () {
            var someSalaryFactoryEmployee = new EmployeeFactory();
            expect( function() { someSalaryFactoryEmployee.createEmployee({ type: "someSalaryEmployee",
                                                                            salary: 50,
                                                                            name: "John Doe",
                                                                            id: 999 }) } ).toThrow();
        });
